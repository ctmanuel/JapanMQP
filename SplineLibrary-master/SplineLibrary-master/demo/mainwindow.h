...
private: //methods
	...
	void rebuildSpline(std::vector<SplineVector3D> pointList);
    std::shared_ptr<Spline> createSpline(const std::vector<SplineVector3D> &pointList, const QString &splineType, bool looping, float alpha, bool includeEndpoints);
