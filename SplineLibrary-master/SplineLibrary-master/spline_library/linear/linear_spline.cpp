...
LinearSpline::LinearSpline(const std::vector<SplineVector3D> &points, double alpha)
{
...
SplineVector3D LinearSpline::getPosition(double x) const
{
...
const std::vector<SplineVector3D> &LinearSpline::getPoints(void) const
{
    return points;
}
