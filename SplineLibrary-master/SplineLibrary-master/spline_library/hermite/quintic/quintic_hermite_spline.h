...
//constructors
public:
    QuinticHermiteSpline(const std::vector<SplineVector3D> &points,
...
protected:
    ...
    inline SplineVector3D computeWiggle(double t, const InterpolationData &segment) const;
...
inline SplineVector3D QuinticHermiteSpline::computePosition(double t, const InterpolationData &segment) const
{
...
inline SplineVector3D QuinticHermiteSpline::computeTangent(double t, const InterpolationData &segment) const
{
...
inline SplineVector3D QuinticHermiteSpline::computeCurvature(double t, const InterpolationData &segment) const
{
...
inline SplineVector3D QuinticHermiteSpline::computeWiggle(double t, const InterpolationData &segment) const
{
