...
QuinticCRSpline::QuinticCRSpline(const std::vector<SplineVector3D> &points, double alpha)
{
    ...
    for(int i = firstTangent; i <= lastTangent; i++)
    {
        ...
        SplineVector3D pPrev = points.at(i - 1);
        SplineVector3D pCurrent = points.at(i);
        SplineVector3D pNext = points.at(i + 1);
    ...
    std::map<int, SplineVector3D> curveMap;
    ...
    for(int i = firstCurvature; i <= lastCurvature; i++)
    {
        ...
        SplineVector3D pPrev = tangentMap.at(i - 1);
        SplineVector3D pCurrent = tangentMap.at(i);
        SplineVector3D pNext = tangentMap.at(i + 1);
