...
CubicHermiteSpline::CubicHermiteSpline(const std::vector<SplineVector3D> &points, const std::vector<SplineVector3D> &tangents, double alpha)
{
...
SplineVector3D CubicHermiteSpline::getPosition(double x) const
{
...
const std::vector<SplineVector3D> &CubicHermiteSpline::getPoints(void) const
{
    return points;
}
