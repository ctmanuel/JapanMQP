...
//constructors
public:
    CubicHermiteSpline(const std::vector<SplineVector3D> &points, const std::vector<SplineVector3D> &tangents, double alpha = 0.0);
protected:
...
inline SplineVector3D CubicHermiteSpline::computePosition(double t, const InterpolationData &segment) const
{
...
inline SplineVector3D CubicHermiteSpline::computeTangent(double t, const InterpolationData &segment) const
{
    double oneMinusT = 1 - t;
...
inline SplineVector3D CubicHermiteSpline::computeCurvature(double t, const InterpolationData &segment) const
{
...
inline SplineVector3D CubicHermiteSpline::computeWiggle(const InterpolationData &segment) const
{
    //tests and such have shown that we have to scale this by the inverse of the t distance, and i'm not sure why
    //intuitively it would just be the 2nd derivative of the position function and nothing else
    //if you know why please let me know
