...
//constructors
public:
    CubicBSpline(const std::vector<SplineVector3D> &points);
protected:
...
struct CubicBSpline::InterpolationData {
    ...
    //points
    SplineVector3D p0, p1, p2, p3;
};

inline SplineVector3D CubicBSpline::computePosition(double t, const InterpolationData &segment) const
{
    return (
...
inline SplineVector3D CubicBSpline::computeTangent(double t, const InterpolationData &segment) const
{
    return (
                segment.p0 * (-(1 - t) * (1 - t)) +
                segment.p1 * (t * (3 * t - 4)) +
...
inline SplineVector3D CubicBSpline::computeCurvature(double t, const InterpolationData &segment) const
{
    return (
                segment.p0 * (1 - t) +
                segment.p1 * (3 * t - 2) +
...
inline SplineVector3D CubicBSpline::computeWiggle(const InterpolationData &segment) const
{
