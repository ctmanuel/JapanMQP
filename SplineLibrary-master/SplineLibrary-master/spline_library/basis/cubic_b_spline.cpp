...
CubicBSpline::CubicBSpline(const std::vector<SplineVector3D> &points)
{
...
SplineVector3D CubicBSpline::getPosition(double x) const
{
...
const std::vector<SplineVector3D> &CubicBSpline::getPoints(void) const
{
    return points;
}
