...
std::unordered_map<int, double> TCalculator::computeTValues(const std::vector<SplineVector3D> &points, double alpha, int padding)
{
...
std::unordered_map<int, double> TCalculator::computeLoopingTValues(const std::vector<SplineVector3D> &points, double alpha, int padding)
{
    int size = points.size();
