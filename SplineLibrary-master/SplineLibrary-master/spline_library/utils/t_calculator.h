...
public:
    ...
    static std::unordered_map<int, double> computeTValues(const std::vector<SplineVector3D> &points, double alpha, int padding);
    ...
    static std::unordered_map<int, double> computeLoopingTValues(const std::vector<SplineVector3D> &points, double alpha, int padding);
};
